...
public class OpenUserFiles extends JInternalFrame implements ActionListener {
	...
	// Cria uma label
	private JLabel textLabel =  new JLabel("Arquivo de Usuário: ", SwingConstants.LEFT);
	...
	public OpenUserFiles(){
		...
		setSize(695,348);
		setTitle("Selecionar Arquivo de Usuário");
	...
	public void actionPerformed(ActionEvent e) { 
		...
		if (open.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
			...
			dispose();
			JOptionPane.showMessageDialog(AppWindow.screen, "O arquivo de usuário foi carregado");
